...
const Categorias = () => {
  return (
    <main className="categorias">
      ...
      <CardCategory imagen="https://res.cloudinary.com/dt9uzksq0/image/upload/v1700848663/mapa_xkginu.jpg" nombre="Provincias" ciudad="Todos lo campings clasificados por provincias" link="/provincias" word="Ver" />
