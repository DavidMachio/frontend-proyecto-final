...
const Categorias = () => {
  return (
    <main className="categorias">
      ...
      <CardCategory imagen="https://res.cloudinary.com/dt9uzksq0/image/upload/v1700848663/mapa_xkginu.jpg" nombre="Comunidades" ciudad="Todos lo campings clasificados por comunidades" link="/comunidades" word="Ver" />
