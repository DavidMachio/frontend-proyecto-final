...
const Categorias = () => {
  return (
    <main className="categorias">
      ...
      <CardCategory imagen="https://res.cloudinary.com/dt9uzksq0/image/upload/v1700137174/montan%CC%83aplaya_lj8xmm.jpg" nombre="Entornos" ciudad="Selecciona el entorno en el que quieres disfrutar de tus vacaciones, podrás elegir entre playa, montaña o ciudad" link="/entornos" word="Ver" />
